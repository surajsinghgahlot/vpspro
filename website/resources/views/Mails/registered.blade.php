	                                             ...
	                                             <tr>
	                                                <td valign="top" style="padding: 0px 48px 0; padding-left: 20px; padding-right: 20px;">
	                                                   <div id="body_content_inner" style="color: #3d3d3d; text-align: left; font-size: 14px; line-height: 25px; font-family: &quot;Lucida Sans Unicode&quot;, &quot;Lucida Grande&quot;, sans-serif; font-weight: 400;">
	                                                      <p style="margin: 0;">Hello,&nbsp;<span style="color: #35536c; font-weight: 600;" >{{$name}}</span></p>
	                                                      <p style="margin: 0; padding: 15px 0">Welcome to aws panel your login email is <b>{{$emailAddress}}</b> and password is <b>{{$password}}</b></p>
                                                          <p style="margin: 0; padding: 15px 0">Pleae login <a href="{{url('/')}}">Login</a></p></p>
                                                          <div style="clear: both; height: 1px;"></div>
	                                                    </div>  
	                                                   </div>
	                                                   <div id="body_content_inner" style="color: #3d3d3d; text-align: left; font-size: 14px; line-height: 25px; font-family: &quot;Lucida Sans Unicode&quot;, &quot;Lucida Grande&quot;, sans-serif; font-weight: 400;">
	                                                      <p style="margin: 0; padding: 15px 0">For more information contact your admin</p>
	                                                      <div style="clear: both; height: 1px;"></div>
	                                                    </div> 
